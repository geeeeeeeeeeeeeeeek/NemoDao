...
import com.nemo.dao.utils.BeanUtils;
import com.nemo.dao.utils.CollectionsUtils;
import com.nemo.dao.utils.StringUtils;
...
public class SqlSession{
    ...
    public Object exec(Class<?> clss, Method method, Object params) throws SQLException {
        ...
        if(type.equals("select")){
            List<Map<String, Object>> modeResult = DataHelper.instance().findModeResult(sql, param);
            return modeResult;
